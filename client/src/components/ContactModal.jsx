...
import { FaGithubAlt, FaLinkedinIn, FaLongArrowAltRight } from 'react-icons/fa'
    ...
    <div>
      <div className='fixed top-0 left-0 h-full w-full flex items-center justify-center px-4 z-30'>
        <div ref={modalRef}  className='relative flex flex-col items-center w-full max-w-[230px] md:max-w-[340px] h-fit pb-4 bg-background dark:bg-gray dark:bg-zinc-800 rounded-lg'>
          ...
          {/* SVG Header Img */}
          <div className='w-full bg-sky-600 dark:bg-sky-700 mx-auto px-8 py-2 mb-4 rounded-t-lg'>
          ...
          {/* Social Media Icons */}
          <div className='px-4'>
              <div className='flex flex-row items-center text-xl sm:text-2xl gap-2 sm:gap-3 text-primary dark:text-darkPrimary'>
                <a
